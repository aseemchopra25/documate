...
# First line of every generated page — deliberately tool-anonymous: nothing written
# into a user's repo names this tool. Shared here so the anchor scanner
...
GENERATED_STAMP = "<!-- generated documentation — edit the source, not this file -->"

# Every stamp ever emitted. Detection (ownership, pruning, scanner skips) matches any
# of these so pages stamped by older releases stay ours; emission uses GENERATED_STAMP.
STAMPS = (
    GENERATED_STAMP,
